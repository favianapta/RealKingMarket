...
<body>
    <header class="header-area header-style-1 header-height-2">
        <div class="header-top header-top-ptb-1 d-none d-lg-block">
                                ...
                                <ul>
                                    <li><i class="fi-rs-user"></i> {{ Auth::user()->name }} /
                                        <form method="post" action="{{ route('logout') }}">
                                            @csrf
                                            <a href="{{ route('logout') }}"
                                                onclick="event.prefentDefault(); this.closest('form').submit();">Logout</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <p class="text-lg-end text-start font-sm text-muted mb-0">
                                &copy; <strong class="text-brand">RealizmKingTech | RealKingMarket</strong> All rights reserved
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <script src="{{ asset('assets/js/plugins/perfect-scrollbar.js') }}{{ asset('assets/js/plugins/perfect-scrollbar.js') }}"></script>
            <script src="{{ asset('assets/js/plugins/magnific-popup.js') }}{{ asset('assets/js/plugins/magnific-popup.js') }}"></script>
